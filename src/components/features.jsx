...
function Features() {
  return (
    ...
    <section class="bg-[#0B0B0F] text-white py-16">
  <div class="max-w-7xl mx-auto px-6 text-center">
    ...
    <p class="text-gray-400 max-w-2xl mx-auto mb-12">
      Built with advanced steganography algorithms to ensure your secrets remain hidden in plain sight.
    </p>
    ...
    <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="bg-[#0B0F19] border border-transparent hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20 rounded-xl p-6 transition duration-300 ease-in-out">
            <div class="flex items-center justify-center w-12 h-12 rounded-lg bg-[#111827] text-blue-500 mb-4">
            ...
            Hide your messages within image pixels using LSB steganography. Completely undetectable to the naked eye.
            </p>
        </div>
      ...
      <div class="bg-[#0B0F19] border border-transparent hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20 rounded-xl p-6 transition duration-300 ease-in-out">
            ...
            <p class="text-gray-400 text-sm">
            All processing happens locally in your browser. Your secrets never leave your device.
            </p>
        </div>
        ...
        <div class="bg-[#0B0F19] border border-transparent hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20 rounded-xl p-6 transition duration-300 ease-in-out">
            ...
            <p class="text-gray-400 text-sm">
           Advanced algorithms ensure rapid encoding and decoding without compromising security.
            </p>
        </div>
        ...
        <div class="bg-[#0B0F19] border border-transparent hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20 rounded-xl p-6 transition duration-300 ease-in-out">
            ...
            <p class="text-gray-400 text-sm">
          Support for PNG, JPEG, and other popular image formats with lossless message embedding.
            </p>
        </div>
        ...
        <div class="bg-[#0B0F19] border border-transparent hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20 rounded-xl p-6 transition duration-300 ease-in-out">
           ...
           Easy Sharing
            ...
            <p class="text-gray-400 text-sm">
         Share encoded images through any platform. Only those with the key can reveal the hidden message.
            </p>
        </div>
     ...
     <div class="bg-[#0B0F19] border border-transparent hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/20 rounded-xl p-6 transition duration-300 ease-in-out">
         ...
         Forensic Resistant
            ...
            <p class="text-gray-400 text-sm">
        Advanced techniques make detection nearly impossible, even with specialized forensic tools.
            </p>
        </div>
